...
opcode_entry opcode_table [512] = {
  /* 0xxx              op1  op2,                                                      */
  /* 0x00               r/m8 r8, r/m16/32 r16/32,           r8 r/m8, r16/32 r/m16/32, */
  /* 0x00 */	IDEXW(G2E, add, 1), IDEX(G2E, add), IDEXW(E2G, add, 1), IDEX(E2G, add),
  /* 0x04               AL imm8,    eAX imm16/32,                                     */
  /* 0x04 */	IDEXW(I2a, add, 1), IDEX(I2a, add), EMPTY, EMPTY,

  /* 0x08 */	IDEXW(G2E, or, 1), IDEX(G2E, or), IDEXW(E2G, or, 1), IDEX(E2G, or),
  /* 0x0c */	IDEXW(I2a, or, 1), IDEX(I2a, or), EMPTY, EX(2byte_esc), // Two-byte Instructions

  /* 0x10                         r16/32 r/m16/32,                                    */
  ...
  /* 0x40 ~ 0x5c    r16/32,       r16/32,       r16/32,       r16/32,                 */
  ...
  /* 0xxx     op1 op2 op3                                                             */
  /* 0x60      AX CX DX, DI SI BP,                                                    */
  /* 0x60 */	EX(pusha), EX(popa), EMPTY, EMPTY,
  /* 0x64 */	EMPTY, EMPTY, EX(operand_size), EMPTY,

  /* 0x68                imm16/32, r16/32 r/m16/32 imm16/32,              imm8, r16/32 r/m16/32 imm8, */
